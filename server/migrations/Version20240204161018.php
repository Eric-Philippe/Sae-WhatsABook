 ...
 */
final class Version20240204161018 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book (id VARCHAR(36) NOT NULL, title VARCHAR(100) NOT NULL, summary LONGTEXT NOT NULL, release_date DATE NOT NULL, language VARCHAR(50) NOT NULL, cover_link VARCHAR(150) NOT NULL, page_number INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE loan (id VARCHAR(36) NOT NULL, book_id VARCHAR(36) DEFAULT NULL, member_id VARCHAR(36) DEFAULT NULL, loan_date DATE NOT NULL, return_date DATE DEFAULT NULL, INDEX IDX_C5D30D0316A2B381 (book_id), INDEX IDX_C5D30D037597D3FE (member_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE reservation (id VARCHAR(36) NOT NULL, book_id VARCHAR(36) DEFAULT NULL, member_id VARCHAR(36) DEFAULT NULL, date_resa DATE NOT NULL, UNIQUE INDEX UNIQ_42C8495516A2B381 (book_id), INDEX IDX_42C849557597D3FE (member_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE suggestion (id VARCHAR(36) NOT NULL, member_id VARCHAR(36) DEFAULT NULL, title VARCHAR(50) NOT NULL, editor VARCHAR(255) NOT NULL, release_date DATE DEFAULT NULL, authors VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, details VARCHAR(255) DEFAULT NULL, INDEX IDX_DD80F31B7597D3FE (member_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE suggestion ADD CONSTRAINT FK_DD80F31B7597D3FE FOREIGN KEY (member_id) REFERENCES member (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE suggestion DROP FOREIGN KEY FK_DD80F31B7597D3FE');
