 ...
 */
final class Version20240202165803 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE loan (id VARCHAR(36) NOT NULL, loan_id VARCHAR(36) DEFAULT NULL, member_id VARCHAR(36) DEFAULT NULL, loan_date DATE NOT NULL, return_date DATE NOT NULL, max_date_return_limit DATE NOT NULL, INDEX IDX_C5D30D03CE73868F (loan_id), INDEX IDX_C5D30D037597D3FE (member_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE loan ADD CONSTRAINT FK_C5D30D03CE73868F FOREIGN KEY (loan_id) REFERENCES book (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE loan DROP FOREIGN KEY FK_C5D30D03CE73868F');
